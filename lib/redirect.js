...
function redirect(document,settings,locale){
	...
	if ((document.location.host == 'toledo.kuleuven.be' || document.location.host == 'www.toledo.kuleuven.be') && document.location.pathname == '/') {
		document.location.href = 'https://toledo.kuleuven.be/portal';
